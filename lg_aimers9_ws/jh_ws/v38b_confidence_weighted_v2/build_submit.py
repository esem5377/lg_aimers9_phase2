...
OUT_ZIP = os.path.join(ROOT, 'v38b_confidence_weighted.zip')
...
files_to_add = [
    ...
    ('model/retrieval_encoder.pt', os.path.join(ROOT, 'model', 'retrieval_encoder.pt')),
    ('model/reference_embeddings.npy', os.path.join(ROOT, 'model', 'reference_embeddings.npy')),
    ...
    ('model/ebglmm_state.pkl', os.path.join(ROOT, 'model', 'ebglmm_state.pkl')),
]
