# script.py
# 987점 베이스(control_risk_score 추가+원재료 제거) + control_quality_score
# + pitcher_net_control("both", 원재료 success_rate/strike_rate는 유지),
# 단일 시드(42). 나머지(trackman context 병합, raw id -1 OOV 인코딩,
# cat_cols 문자열화, Platt calibration)는 v18/v20/v22와 동일.
import json
import os
