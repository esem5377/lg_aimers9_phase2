...
RESULT_PATH = os.path.join(OUT_DIR, "wider_temp_fold2_scale15_results.json")
CKPT_CALIB = os.path.join(OUT_DIR, "ckpt_fold2_s15_calib_preds.npy")
CKPT_CALIB_IDX = os.path.join(OUT_DIR, "ckpt_fold2_s15_calib_idx.txt")
CKPT_EVAL = os.path.join(OUT_DIR, "ckpt_fold2_s15_eval_preds.npy")
CKPT_EVAL_IDX = os.path.join(OUT_DIR, "ckpt_fold2_s15_eval_idx.txt")
