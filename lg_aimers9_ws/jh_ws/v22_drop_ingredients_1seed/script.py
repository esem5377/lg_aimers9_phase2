# script.py
# 992점(v20 control_risk_score) 레시피에서 원재료(reverse_rate/middle_rate/
# ball_rate) 3개를 제거하고 control_risk_score/_weighted 2개만 유지, 단일
# 시드(42). 나머지(trackman context 병합, raw id -1 OOV 인코딩, cat_cols
# 문자열화, Platt calibration)는 v18/v20과 동일.
import json
import os
