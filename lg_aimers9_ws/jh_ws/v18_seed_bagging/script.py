# script.py
# 974점(es_ws v7) 레시피 + 시드 배깅(3개 모델, seed 42/7/123)의 raw 확률
# 평균 -> 그 위에 Platt calibration 1회 적용. 나머지(trackman context 병합,
# raw id -1 OOV 인코딩, cat_cols 문자열화)는 기존 프로덕션과 동일.
import json
import os
