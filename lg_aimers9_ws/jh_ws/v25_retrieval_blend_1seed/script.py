# script.py
# 987점(v22) 레시피 CatBoost + retrieval(ModernNCA 스타일) 블렌드, 단일 시드.
# retrieval은 참조 데이터 50만행(서버 10분 추론 제한 안전마진)과의 exact
# kernel regression으로 예측, CatBoost 예측과 평균 후 Platt calibration 적용.
import json
import os
