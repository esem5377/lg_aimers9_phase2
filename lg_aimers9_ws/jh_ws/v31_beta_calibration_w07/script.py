# script.py
# v25(1020점, 987 레시피 CatBoost + retrieval NCA 블렌드)와 CatBoost/encoder/
# 참조 임베딩(133만행, 서브샘플 없음)을 그대로 재사용 -- 재학습 없이 블렌드
# 가중치만 50:50 -> 70:30(CatBoost:retrieval)로 교체(그리드서치 결과 로컬
# calib carve-out 기준 최적, calibrated BSS 2071.52 -> 2082.78, +11.26).
