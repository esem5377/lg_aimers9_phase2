# script.py
# jh_ws v26(1023점, 1시드 CatBoost + retrieval NCA 블렌드, w_cb=0.7)에서
# CatBoost만 6시드 배깅(42/7/123/1/99/777)으로 교체. retrieval encoder는
# v26의 검증된 것을 그대로 재사용(재학습 안 함, GPU 재학습 시 NCA 품질이
# 저하되는 현상을 확인해 회피 -- carve-out raw BSS 1896.79 -> 재학습판
# 1845.04로 하락했었음). carve-out calibrated BSS: 2082.78(v26) -> 2085.15
# (+2.37, w_cb=0.70 그대로가 최적으로 재확인됨).
import json
import os
...
def main():
    ...
    print("CatBoost inference (6시드 평균)...")
